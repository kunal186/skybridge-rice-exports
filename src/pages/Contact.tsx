            ...
            <motion.div {...fadeIn} className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  <a href="mailto:info@skybridgeglobal.com" className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground text-sm">info@skybridgeglobal.com</div>
                    </div>
                  </a>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3.5 rounded-md bg-forest text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity"
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-md border border-input bg-card text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full px-4 py-3 rounded-md border border-input bg-card text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-ring resize-none"
                      placeholder="Tell us about your requirements — rice variety, quantity, destination, packaging preferences..."
                      maxLength={2000}
                    />
                  </div>
                  <button
